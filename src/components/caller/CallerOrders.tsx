...
const statusConfig = {
  ...
  reported: { label: "Reportée", class: "bg-muted text-muted-foreground border-border", icon: Clock },
    ...
    <div className="space-y-4">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger value="reported">Reportées</TabsTrigger>
          <TabsTrigger value="cancelled">Annulées</TabsTrigger>
        </TabsList>

        {["pending", "confirmed", "reported", "cancelled"].map((status) => (
