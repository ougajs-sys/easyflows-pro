-- Add manual withdrawal function for supervisors/admins to withdraw stock from delivery persons
-- This allows forced withdrawal with mandatory reason and notifies the delivery person
...
COMMENT ON FUNCTION public.manual_withdrawal_from_delivery IS 
  'Allows supervisors and administrators to manually withdraw stock from a delivery person with a mandatory reason. The delivery person is notified via the stock_movements table.';
